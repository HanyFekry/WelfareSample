...
{
    public partial class DisbursementRequestConfiguration : IEntityTypeConfiguration<DisbursementRequest>
    {
        public void Configure(EntityTypeBuilder<DisbursementRequest> entity)
        {
            entity.ToTable("DisbursementRequest");
            entity.HasKey(x => x.DisbursementRequestId);
            ...
            entity.OwnsMany<StepConfiguration>(
                ...
                b =>
                {
                    b.ToTable("DisbursementRequestStepConfiguration");
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<DisbursementRequest> entity);
    }
}
