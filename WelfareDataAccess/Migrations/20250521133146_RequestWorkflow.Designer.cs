...
[Migration("20250521133146_RequestWorkflow")]
...
#pragma warning disable 612, 618
        ...
        modelBuilder.Entity("WelfareDataAccess.Entities.ActionType", b =>
            {
        ...
        modelBuilder.Entity("WelfareDataAccess.Entities.AttachmentType", b =>
            {
                ...
                b.Property<int>("AttachmentEntityType")
                    .HasColumnType("int")
                    .HasComment("Enum value(WelfareRequest,Memo,Batch)");
        ...
        modelBuilder.Entity("WelfareDataAccess.Entities.BatchRequest", b =>
            {
        ...
        modelBuilder.Entity("WelfareDataAccess.Entities.BatchRequestAction", b =>
            {
        ...
        modelBuilder.Entity("WelfareDataAccess.Entities.BatchRequestAttachment", b =>
            {
        ...
        modelBuilder.Entity("WelfareDataAccess.Entities.BatchRequestStep", b =>
            {
                b.Property<int>("BatchRequestStepId")
                    .HasColumnType("int");
        ...
        modelBuilder.Entity("WelfareDataAccess.Entities.Memorandum", b =>
            {
        ...
        modelBuilder.Entity("WelfareDataAccess.Entities.MemorandumAttachment", b =>
            {
        ...
        modelBuilder.Entity("WelfareDataAccess.Entities.WelfareRequest", b =>
            {
        ...
        modelBuilder.Entity("WelfareDataAccess.Entities.WelfareRequestAction", b =>
            {
        ...
        modelBuilder.Entity("WelfareDataAccess.Entities.WelfareRequestAttachment", b =>
            {
        ...
        modelBuilder.Entity("WelfareDataAccess.Entities.WelfareRequestStep", b =>
            {
                b.Property<int>("WelfareRequestStepId")
                    .HasColumnType("int");
        ...
        modelBuilder.Entity("WelfareDataAccess.Entities.WorkflowReason", b =>
            {
                b.Property<int>("WorkflowReasonId")
                    .HasColumnType("int");
        ...
        modelBuilder.Entity("WelfareDataAccess.Entities.DisabilityWelfareRequest", b =>
            {
                b.HasBaseType("WelfareDataAccess.Entities.WelfareRequest");
        ...
        modelBuilder.Entity("ActionTypeBatchRequestStep", b =>
            {
                b.HasOne("WelfareDataAccess.Entities.ActionType", null)
                    .WithMany()
                    .HasForeignKey("ActionTypesActionTypeId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();

                b.HasOne("WelfareDataAccess.Entities.BatchRequestStep", null)
                    .WithMany()
        ...
        modelBuilder.Entity("ActionTypeWelfareRequestStep", b =>
            {
                ...
                b.HasOne("WelfareDataAccess.Entities.WelfareRequestStep", null)
                    .WithMany()
        ...
        modelBuilder.Entity("WelfareDataAccess.Entities.BatchRequestAction", b =>
            {
                b.HasOne("WelfareDataAccess.Entities.ActionType", "ActionType")
                    .WithMany("BatchRequestActions")
                    .HasForeignKey("ActionTypeId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();

                b.HasOne("WelfareDataAccess.Entities.BatchRequest", "BatchRequest")
                    .WithMany("BatchRequestActions")
                    .HasForeignKey("BatchRequestId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();

                b.HasOne("WelfareDataAccess.Entities.BatchRequestStep", "BatchRequestStep")
                    .WithMany("BatchRequestActions")
                    .HasForeignKey("BatchRequestStepId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();

                b.HasOne("WelfareDataAccess.Entities.WorkflowReason", "WorkflowReason")
                    .WithMany("BatchRequestActions")
        ...
        modelBuilder.Entity("WelfareDataAccess.Entities.BatchRequestAttachment", b =>
            {
                ...
                b.HasOne("WelfareDataAccess.Entities.BatchRequest", "Batch")
                    .WithMany("BatchRequestAttachments")
        ...
        modelBuilder.Entity("WelfareDataAccess.Entities.Memorandum", b =>
            {
                b.HasOne("WelfareDataAccess.Entities.RequestType", "RequestTypeNavigation")
                    .WithMany("Memoranda")
        ...
        modelBuilder.Entity("WelfareDataAccess.Entities.MemorandumAttachment", b =>
            {
                ...
                b.HasOne("WelfareDataAccess.Entities.Memorandum", "Memorandum")
                    .WithMany("MemorandumAttachments")
        ...
        modelBuilder.Entity("WelfareDataAccess.Entities.WelfareRequest", b =>
            {
                ...
                b.HasOne("WelfareDataAccess.Entities.RequestStatus", "RequestStatus")
                    .WithMany("WelfareRequests")
        ...
        modelBuilder.Entity("WelfareDataAccess.Entities.WelfareRequestAction", b =>
            {
                ...
                b.HasOne("WelfareDataAccess.Entities.WelfareRequest", "WelfareRequest")
                    .WithMany("WelfareRequestActions")
                    .HasForeignKey("WelfareRequestId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();

                b.HasOne("WelfareDataAccess.Entities.WelfareRequestStep", "WelfareRequestStep")
                    .WithMany("WelfareRequestActions")
        ...
        modelBuilder.Entity("WelfareDataAccess.Entities.WelfareRequestAttachment", b =>
            {
                ...
                b.HasOne("WelfareDataAccess.Entities.WelfareRequest", "Request")
                    .WithMany("WelfareRequestAttachments")
        ...
        modelBuilder.Entity("WelfareTypesAttachmentTypes", b =>
            {
                b.HasOne("WelfareDataAccess.Entities.AttachmentType", null)
                    .WithMany()
                    .HasForeignKey("AttachmentTypeId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();

                b.HasOne("WelfareDataAccess.Entities.WelfareType", null)
                    .WithMany()
                    .HasForeignKey("WelfareTypeId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();
        ...
        modelBuilder.Entity("WelfareDataAccess.Entities.DisabilityWelfareRequest", b =>
            {
                b.HasOne("WelfareDataAccess.Entities.WelfareRequest", null)
                    .WithOne()
                    .HasForeignKey("WelfareDataAccess.Entities.DisabilityWelfareRequest", "WelfareRequestId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();
            });
        ...
        modelBuilder.Entity("WelfareDataAccess.Entities.SocialWelfareRequest", b =>
            {
                ...
                b.HasOne("WelfareDataAccess.Entities.WelfareRequest", null)
                    .WithOne()
                    .HasForeignKey("WelfareDataAccess.Entities.SocialWelfareRequest", "WelfareRequestId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();
